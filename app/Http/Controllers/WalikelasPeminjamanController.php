...
class WalikelasPeminjamanController extends Controller
{
    ...
    public function index()
    {
        ...
        $api_url = 'http://192.168.1.2:3000/api/walikelas/pemijamanview?op_id='.$op_id;
    ...
    public function searchpeminjaman(Request $request)
    {
        ...
        $api_url = 'http://192.168.1.2:3000/api/walikelas/peminjamansearch?nama_siswa='.$nama_siswa.'&nama_buku='.$nama_buku.'&tgl_min='.$tgl_min.'&tgl_maks='.$tgl_maks.'&op_id='.$op_id;
    ...
    public function add()
    {
        ...
        // ----- data siswa ------//
        $api_url_siswa_peminjaman = 'http://192.168.1.2:3000/api/walikelas/data_siswapeminjaman?kelas='.$kelas;
        ...
        // ----- data buku ------//
        $api_url_buku_peminjaman = 'http://192.168.1.2:3000/api/walikelas/data_bukupeminjaman?kelas='.$kelas;

...
class WalikelasPengembalianController extends Controller
{
    ...
    public function index()
    {
        ...
        $api_url = 'http://192.168.1.2:3000/api/walikelas/pengembalianview?op_id='.$op_id;
    ...
    public function searchpengembalian(Request $request)
    {
        ...
        $api_url = 'http://192.168.1.2:3000/api/walikelas/pengembaliansearch?nama_siswa='.$nama_siswa.'&nama_buku='.$nama_buku.'&tgl_min='.$tgl_min.'&tgl_maks='.$tgl_maks.'&op_id='.$op_id;
